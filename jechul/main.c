...
/*   Updated: 2024/08/13 20:52:08 by junkwak          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv, char **envp)
{
	...
	pipex.f_content = open (argv[1], O_RDONLY);
	pipex.s_content = open (argv[4], O_RDWR | O_CREAT | O_TRUNC);
	if (pipex.f_content == -1 || pipex.s_content == -1)
		ft_error("child error f.c_ps1", &pipex);
